    ...
    <div className="device-composition">
      <div className="browser-card">
        ...
        <div className={`asset-slot ${desktopReady ? "has-project-image" : ""}`}>
          ...
          {!desktopReady && <div className="asset-fallback"><small>LIVE PROJECT</small><strong>{name}</strong><em>Built for real life.</em><span>PROJECT SCREENSHOT COMING NEXT</span></div>}
        </div>
      </div>
