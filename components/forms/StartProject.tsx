 ...
 return <section className="sheet start-sheet" id="start"><div className="start-project">
  ...
  <form className="project-builder" onSubmit={submit}>
   ...
   <div className="builder-split">
    <fieldset className="builder-step"><legend><span>03</span>What's the timing?</legend><div className="builder-options">{timingOptions.map(o=><button key={o} type="button" className={timing===o?"selected":""} aria-pressed={timing===o} onClick={()=>setTiming(o)}>{o}</button>)}</div></fieldset>
    <fieldset className="builder-step"><legend><span>04</span>What's the investment?</legend><div className="builder-options">{investmentOptions.map(o=><button key={o} type="button" className={investment===o?"selected":""} aria-pressed={investment===o} onClick={()=>setInvestment(o)}>{o}</button>)}</div></fieldset>
   </div>
